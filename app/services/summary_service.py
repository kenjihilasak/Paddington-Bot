...
class SummaryService:
        ...
        return SummaryResponse(
            ...
            exchange_offers=SummarySection(
                ...
                items=[
                    SummaryItem(
                        id=item.id,
                        title=f"{item.offer_currency} to {item.want_currency}",
                        location=item.location,
                        amount=item.amount,
                        currency=item.offer_currency,
                        secondary_currency=item.want_currency,
    ...
    async def render_compact_text(self) -> str:
        ...
        lines.append(f"Listings: {summary.listings.count}")
        ...
        lines.append(f"Events: {summary.events.count}")
